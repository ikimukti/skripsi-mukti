...
it_admin_menus = [
    ...
    create_menu('Account', '/account/', 'fas fa-user', dropdown=True, id='account_detail', submenus=[
        create_menu('Profile', '/account/profile/', 'fas fa-user-circle', id='account_detail'),
        create_menu('Change Password', '/account/change-password/', 'fas fa-key', id='account_change_password'),
    ]),
    create_menu('Manage', '/manage/', 'fas fa-cogs', dropdown=True, id='manage', submenus=[
        ...
        create_menu('Permission', '/manage/permission/', 'fas fa-user-lock', id='manage_permission'),
    ...
    create_menu('Images', '/image/', 'fas fa-image', dropdown=True, id='image', submenus=[
        ...
        create_menu('Image by Uploader', '/image/uploader/', 'fas fa-user', id='image_by_uploader'),
        create_menu('Upload', '/image/upload/', 'fas fa-upload', id='image_upload'),
        create_menu('Summary', '/image/summary/', 'fas fa-chart-bar', id='image_summary'),
    ]),
    create_menu('Segmentation', '/segmentation/', 'fas fa-chart-pie', dropdown=True, id='segmentation', submenus=[
        create_menu('Segmentation Process', '/segmentation/process/', 'fas fa-cog', id='segmentation_process'),
        create_menu('Segmentation All', '/segmentation/', 'fas fa-list', id='segmentation'),
        create_menu('Summary', '/segmentation/summary/', 'fas fa-chart-bar', id='segmentation_summary'),
    ]),
    create_menu('Reports', '/report/', 'fas fa-chart-bar', dropdown=True, id='report', submenus=[
        create_menu('Segmentation', '/report/segmentation/', 'fas fa-chart-pie', id='report_segmentation'),
        create_menu('Export Image', '/report/export/image/', 'fas fa-file-image', id='report_export_image'),
        create_menu('Export Report', '/report/export/report/', 'fas fa-file-pdf', id='report_export_report'),
        create_menu('Summary', '/report/summary/', 'fas fa-chart-bar', id='report_summary'),
    ]),
    create_menu('Preferences', '/preference/', 'fas fa-cog', dropdown=True, id='preference', submenus=[
        create_menu('Setting', '/preference/setting/', 'fas fa-cog', id='preference_setting'),
